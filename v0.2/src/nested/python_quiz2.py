...
class PQLevelTwo(PythonQuiz):
    ...
    def __init__(self):
        ...
        self._all_games += [self.guess_the_index_nested, self.nested_dict_indexing]
        pass
    ...
    def guess_the_index_nested(self,dims=2,width=4):
        ...
        while response != 'quit': 
            ...
            response = input(f"What is the 'row and column' of {correct_value} in the 2-D matrix above? ")
            try:
